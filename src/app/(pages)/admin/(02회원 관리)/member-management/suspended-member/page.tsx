...
import row2Column5 from "@/data/tables/row2Column5";
import HeaderDropDown from "@/components/HeaderDropDown";
import InputWithLabel from "@/components/InputWithLabel";

const SuspendedMemberManagement = () => {
  const {
  ...
  }, [page, row2Column5, viewValue, rowsPerPage]);
      ...
      <main className="rounded-[20px] bg-white py-6 px-5 mt-6 ">
        <div className="flex items-center justify-between">
          <div className="flex h-fit items-center gap-2 text-secondGray">
            ...
            <button className="rounded-md px-3 py-2 bg-bgGray">
              정지 해제
            </button>
            <button className="rounded-md px-3 py-2 bg-bgGray">
              강제 탈퇴
            ...
            <button className="rounded-md px-3 py-2 bg-bgGray">메일</button>
          </div>
            ...
            <TableBody>
              {items.map((row) => (
                <TableRow key={row.id} className="border-b-1">
                  ...
                  <TableCell className="text-nowrap">{row.stopDate}</TableCell>
                  <TableCell>
                    <Link
...
export default SuspendedMemberManagement;
